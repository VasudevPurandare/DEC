        ...
        <div class="col-lg-6 mx-auto">
            <div class="card ">
                <div class="card-header">
					...
					confirmation number is: <%=request.getAttribute("orderId")%>
				</div>
				</div>
				</div>
				<div class="form-group">		
					<a href="${pageContext.request.contextPath}/purchase" class="form-control btn btn-primary btn-md">Shop Again....</a> 
				</div>
				</div>
				</div>
