						...
						<form:form modelAttribute="shippingInfo" method="post"
							...
							<div class="table">
								<div class="form-group">
									...
									<form:input path="name" placeholder=" Reciever Name"
										class="form-control " />
								</div>
									...
									<div class="input-group">
										<div class="form-group mr-auto ">
											...
											<div class="form-group">
												...
												<form:input path="zip" placeholder="Zip Code"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<div>
												<label>City:</label>
												<form:input path="state" placeholder="City"
													class="form-control " />
												<label>State:</label>
												<form:input path="city" placeholder="State"
													class="form-control " />
											</div>
										</div>
									</div>
